...
public class HuffmanOnDrugs implements Algorithm {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path path = Paths.get("src/abgabe05/resources/drugs.txt");
        long length = Files.size(path);
        InputStream filestream = Files.newInputStream(path);
        OutputStream compressedFile = Files
            .newOutputStream(
                Paths.get("src/abgabe05/resources/compressed/drugs.txt"));
        
        huffman.compress(filestream, compressedFile, length);
        
        InputStream file = Files
            .newInputStream(Paths.get("src/abgabe05/resources/compressed/drugs.txt"));
        OutputStream decompressedFile = Files
            .newOutputStream(Paths.get("src/abgabe05/resources/decompressed/drugs.txt"));
