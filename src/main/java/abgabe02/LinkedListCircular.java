 ...
 */
public class LinkedListCircular<E> implements ICircularBuffer<E> {
	...
	/**
	 * uses the private Method getNode to get the data of the element on the
	 * given index
	 * 
	 * @param index
	 * @return E
	...
	/**
	 * removes the element on the index and gives it back NumberOfNodes
	 * decreases
	 * 
	 * @param index
	 * @return Node<E>
	...
	/**
	 * Method to delete the first element of the list. allows us to work without
	 * the getNode method and has a better performance then deleteNode method
	 * 
	 * @return
	 */
	...
	/**
	 * searches for the Node on the index and gives it back positive and
	...
	private Node<E> getNode(int index) throws NoSuchElementException {
		...
		/**
		 * @see http://stackoverflow.com/a/5385053 the operation of the double
		 *      modulo, allows us to give accept negativ indizes
		 */
	...
	/**
	 * iterates through the list and appends each Nodes data to a readable
	 * String
	 * 
	 * @return String
	 */
